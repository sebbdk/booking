<?php
	...
	$imagePath = isset($this->data[$model]) && !empty($this->data[$model][$field . '_url']) ? $this->data[$model][$field . '_url']:'';
...
<div class="form-group">
	...
	<div class="assetfile-block well">
		...
		<?php echo $this->Form->input('Ignore.file', ['type' => 'file', 'label' => false, 'div' => false, 'id' => $id, 'accept' => $accept]); ?>
